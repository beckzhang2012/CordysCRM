export default {
  ...
  'customer.tag': '标签',
  'customer.noTag': '暂无标签',
  'customer.selectTag': '选择标签',
  'customer.searchTag': '搜索标签',
  'customer.noTagAvailable': '暂无可用标签',
  'customer.createTag': '创建标签',
  'customer.tagName': '标签名称',
  'customer.tagNamePlaceholder': '请输入标签名称',
  'customer.tagNameRequired': '标签名称不能为空',
  'customer.tagColor': '标签颜色',
  'customer.tagFilter': '标签筛选',
};
