export default {
  ...
  'customer.pleaseInputReminderContent': '请输入提醒内容',
  'customer.reminderTimeCannotBeInPast': '提醒时间不能是过去时间',
  'customer.reminderSetSuccess': '提醒设置成功',
  'customer.reminderSetFailed': '提醒设置失败',
  'customer.reminderList': '提醒列表',
  'customer.noReminders': '暂无提醒',
  'customer.upcomingReminders': '即将到来的提醒',
  'customer.noUpcomingReminders': '暂无即将到来的提醒',
  'customer.allReminders': '所有提醒',
  'customer.markAsProcessed': '标记已处理',
  'customer.processed': '已处理',
  'customer.expired': '已过期',
  'customer.reminderDeleteSuccess': '提醒删除成功',
  'customer.reminderDeleteFailed': '提醒删除失败',
  'customer.reminderMarkedAsProcessed': '提醒已标记为已处理',
  'customer.reminderMarkFailed': '标记失败',
  'customer.reminderNotification': '您有 {count} 个客户跟进提醒',
};
