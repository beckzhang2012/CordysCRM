export default {
  ...
  // 客户跟进提醒
  'customer.reminder.setReminder': '设置提醒',
  'customer.reminder.reminderTime': '提醒时间',
  'customer.reminder.content': '提醒内容',
  'customer.reminder.selectTime': '请选择提醒时间',
  'customer.reminder.contentPlaceholder': '请输入提醒内容，最多500字',
  'customer.reminder.timeRequired': '请选择提醒时间',
  'customer.reminder.contentRequired': '请输入提醒内容',
  'customer.reminder.contentMaxLength': '提醒内容最多500字',
  'customer.reminder.setSuccess': '提醒设置成功',
  'customer.reminder.customerName': '客户名称',
  'customer.reminder.reminderList': '提醒列表',
  'customer.reminder.noReminder': '暂无提醒',
  'customer.reminder.markAllRead': '全部已读',
  'customer.reminder.markRead': '标记已读',
  'customer.reminder.deleteConfirm': '确定删除该提醒吗？',
  'customer.reminder.viewAll': '查看全部',
  'customer.reminder.reminderManagement': '提醒管理',
  'customer.reminder.clearAll': '清空全部',
  'customer.reminder.clearAllConfirm': '确定清空所有提醒吗？此操作不可恢复。',
  'customer.reminder.searchPlaceholder': '搜索客户名称或提醒内容',
  'customer.reminder.filterStatus': '筛选状态',
  'customer.reminder.status': '状态',
  'customer.reminder.unread': '未读',
  'customer.reminder.read': '已读',
  'customer.reminder.noData': '暂无数据',
  'customer.reminder.reminderTitle': '客户跟进提醒',
};
