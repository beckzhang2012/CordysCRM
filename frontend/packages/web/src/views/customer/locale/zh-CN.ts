export default {
  ...
  'customer.tag.edit': '编辑标签',
  'customer.tag.select': '选择标签',
  'customer.tag.name': '标签名称',
  'customer.tag.color': '标签颜色',
  'customer.tag.namePlaceholder': '请输入标签名称',
  'customer.tag.nameRequired': '请输入标签名称',
  'customer.tag.nameMaxLength': '标签名称最多20个字符',
  'customer.tag.searchPlaceholder': '搜索标签',
  'customer.tag.empty': '暂无标签',
  'customer.tag.noResult': '未找到标签',
  'customer.tag.createNew': '创建新标签',
  'customer.tag.addSuccess': '添加标签成功',
  'customer.tag.updateSuccess': '更新标签成功',
  'customer.tag.removeSuccess': '移除标签成功',
  'customer.tag.bindSuccess': '绑定标签成功',
  'customer.tag.addFailed': '添加标签失败',
  'customer.tag.removeFailed': '移除标签失败',
  'customer.tag.bindFailed': '绑定标签失败',
};
