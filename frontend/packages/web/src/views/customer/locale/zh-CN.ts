export default {
  ...
  'customer.reminderNotification': '提醒通知',
  'customer.pendingReminder': '待处理',
  'customer.completedReminder': '已完成',
  'customer.cancelledReminder': '已取消',
  'customer.cancelReminder': '取消提醒',
  'customer.deleteReminder': '删除提醒',
  'customer.markAsDone': '标记已完成',
  'customer.noReminders': '暂无提醒',
  'customer.reminderFor': '提醒：{name} 客户跟进',
  'customer.reminderAt': '提醒时间：{time}',
  'customer.reminderStatus': '提醒状态',
  'customer.reminderAction': '操作',
  'customer.confirmCancelReminder': '确认取消该提醒吗？',
  'customer.confirmDeleteReminder': '确认删除该提醒吗？',
  'customer.reminderCancelSuccess': '提醒已取消',
  'customer.reminderDeleteSuccess': '提醒已删除',
  'customer.reminderCompleteSuccess': '提醒已完成',
};
