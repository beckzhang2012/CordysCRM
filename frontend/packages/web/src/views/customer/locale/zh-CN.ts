export default {
  ...
  'customer.mergePreview': '合并预览',
  'customer.mergeToCustomer': '合并至主客户',
  'customer.primaryCustomer': '主客户',
  'customer.secondaryCustomers': '被合并客户',
  'customer.secondaryCustomer': '副客户',
  'customer.mergeStatistics': '合并统计',
  'customer.contactCount': '联系人',
  'customer.opportunityCount': '商机',
  'customer.contractCount': '合同',
  'customer.paymentPlanCount': '回款计划',
  'customer.followRecordCount': '跟进记录',
  'customer.followPlanCount': '跟进计划',
  'customer.conflictFields': '冲突字段',
  'customer.conflictFieldsTip': '部分字段存在冲突，请选择保留哪一客户的值',
  'customer.primaryCustomerValue': '主客户: {value}',
