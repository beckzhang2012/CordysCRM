export default {
  ...
  'customer.reminder.remindTime': '提醒时间',
  'customer.reminder.selectTime': '选择提醒时间',
  'customer.reminder.content': '提醒内容',
  'customer.reminder.contentPlaceholder': '请输入提醒内容',
  'customer.reminder.timeRequired': '请选择提醒时间',
  'customer.reminder.contentRequired': '请输入提醒内容',
  'customer.reminder.contentMaxLength': '提醒内容不能超过500个字符',
  'customer.reminder.setSuccess': '设置提醒成功',
  'customer.reminder.reminderList': '提醒列表',
  'customer.reminder.allReminders': '所有提醒',
  'customer.reminder.noReminder': '暂无提醒',
  'customer.reminder.markAllRead': '全部已读',
  'customer.reminder.markReadSuccess': '标记已读成功',
  'customer.reminder.markAllReadSuccess': '全部标记已读成功',
  'customer.reminder.deleteConfirm': '确定删除该提醒吗？',
  'customer.reminder.viewAll': '查看全部',
  'customer.reminder.pending': '待处理',
  'customer.reminder.read': '已读',
  'customer.reminder.today': '今天',
};
