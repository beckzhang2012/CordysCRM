export default {
  ...
  // 客户提醒
  'customer.reminder': '客户提醒',
  'customer.setReminder': '设置提醒',
  'customer.reminderTime': '提醒时间',
  'customer.reminderContent': '提醒内容',
  'customer.reminderList': '提醒列表',
  'customer.addReminder': '添加提醒',
  'customer.editReminder': '编辑提醒',
  'customer.deleteReminder': '删除提醒',
  'customer.reminderStatus': '提醒状态',
  'customer.reminderStatus.PENDING': '待提醒',
  'customer.reminderStatus.TRIGGERED': '已提醒',
  'customer.reminderStatus.DISMISSED': '已取消',
  'customer.reminderNotification': '客户提醒通知',
  'customer.pleaseSelectReminderTime': '请选择提醒时间',
  'customer.pleaseEnterReminderContent': '请输入提醒内容',
  'customer.reminderContentPlaceholder': '请输入提醒内容，最多1000字符',
  'customer.reminderSetSuccess': '提醒设置成功',
  'customer.reminderDeleteSuccess': '提醒删除成功',
  'customer.reminderDismissSuccess': '提醒取消成功',
  'customer.reminderUpdateSuccess': '提醒更新成功',
  'customer.confirmDeleteReminder': '确认删除该提醒吗？',
  'customer.noReminders': '暂无提醒',
  'customer.viewAllReminders': '查看全部提醒',
  'customer.confirmDismissReminder': '确认取消该提醒吗？',
};
