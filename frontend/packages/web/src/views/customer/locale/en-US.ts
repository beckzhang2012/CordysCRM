export default {
  ...
  'customer.mergePreview': 'Merge Preview',
  'customer.mergeToCustomer': 'Merge to Primary Account',
  'customer.primaryCustomer': 'Primary',
  'customer.secondaryCustomers': 'Secondary Accounts',
  'customer.secondaryCustomer': 'Secondary',
  'customer.mergeStatistics': 'Merge Statistics',
  'customer.contactCount': 'Contacts',
  'customer.opportunityCount': 'Opportunities',
  'customer.contractCount': 'Contracts',
  'customer.paymentPlanCount': 'Payment Plans',
  'customer.followRecordCount': 'Follow-up Records',
  'customer.followPlanCount': 'Follow-up Plans',
  'customer.conflictFields': 'Conflict Fields',
  'customer.conflictFieldsTip': 'Some fields have conflicts, please select which value to keep',
  'customer.primaryCustomerValue': 'Primary: {value}',
  'customer.secondaryCustomerValue': '{name}: {value}',
};
