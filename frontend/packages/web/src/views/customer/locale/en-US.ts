export default {
  ...
  'customer.tag.edit': 'Edit Tag',
  'customer.tag.select': 'Select Tags',
  'customer.tag.name': 'Tag Name',
  'customer.tag.color': 'Tag Color',
  'customer.tag.namePlaceholder': 'Enter tag name',
  'customer.tag.nameRequired': 'Please enter tag name',
  'customer.tag.nameMaxLength': 'Tag name max 20 characters',
  'customer.tag.searchPlaceholder': 'Search tags',
  'customer.tag.empty': 'No tags',
  'customer.tag.noResult': 'No tags found',
  'customer.tag.createNew': 'Create New Tag',
  'customer.tag.addSuccess': 'Tag added successfully',
  'customer.tag.updateSuccess': 'Tag updated successfully',
  'customer.tag.removeSuccess': 'Tag removed successfully',
  'customer.tag.bindSuccess': 'Tags bound successfully',
  'customer.tag.addFailed': 'Failed to add tag',
  'customer.tag.removeFailed': 'Failed to remove tag',
  'customer.tag.bindFailed': 'Failed to bind tags',
};
