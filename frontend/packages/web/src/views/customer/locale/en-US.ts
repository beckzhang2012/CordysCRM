export default {
  ...
  'customer.reminderNotification': 'Reminder Notification',
  'customer.pendingReminder': 'Pending',
  'customer.completedReminder': 'Completed',
  'customer.cancelledReminder': 'Cancelled',
  'customer.cancelReminder': 'Cancel Reminder',
  'customer.deleteReminder': 'Delete Reminder',
  'customer.markAsDone': 'Mark as Done',
  'customer.noReminders': 'No reminders',
  'customer.reminderFor': 'Reminder: {name} follow-up',
  'customer.reminderAt': 'Remind at: {time}',
  'customer.reminderStatus': 'Reminder Status',
  'customer.reminderAction': 'Action',
  'customer.confirmCancelReminder': 'Are you sure to cancel this reminder?',
  'customer.confirmDeleteReminder': 'Are you sure to delete this reminder?',
  'customer.reminderCancelSuccess': 'Reminder cancelled',
  'customer.reminderDeleteSuccess': 'Reminder deleted',
  'customer.reminderCompleteSuccess': 'Reminder completed',
};
