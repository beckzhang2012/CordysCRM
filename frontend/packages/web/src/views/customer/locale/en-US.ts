export default {
  ...
  'customer.reminder.setReminder': 'Set Reminder',
  'customer.reminder.reminderTime': 'Reminder Time',
  'customer.reminder.content': 'Reminder Content',
  'customer.reminder.selectTime': 'Please select reminder time',
  'customer.reminder.contentPlaceholder': 'Please enter reminder content, max 500 characters',
  'customer.reminder.timeRequired': 'Please select reminder time',
  'customer.reminder.contentRequired': 'Please enter reminder content',
  'customer.reminder.contentMaxLength': 'Reminder content max 500 characters',
  'customer.reminder.setSuccess': 'Reminder set successfully',
  'customer.reminder.customerName': 'Customer Name',
  'customer.reminder.reminderList': 'Reminder List',
  'customer.reminder.noReminder': 'No reminders',
  'customer.reminder.markAllRead': 'Mark All Read',
  'customer.reminder.markRead': 'Mark Read',
  'customer.reminder.deleteConfirm': 'Are you sure to delete this reminder?',
  'customer.reminder.viewAll': 'View All',
  'customer.reminder.reminderManagement': 'Reminder Management',
  'customer.reminder.clearAll': 'Clear All',
  'customer.reminder.clearAllConfirm': 'Are you sure to clear all reminders? This action cannot be undone.',
  'customer.reminder.searchPlaceholder': 'Search customer name or reminder content',
  'customer.reminder.filterStatus': 'Filter Status',
  'customer.reminder.status': 'Status',
  'customer.reminder.unread': 'Unread',
  'customer.reminder.read': 'Read',
  'customer.reminder.noData': 'No Data',
  'customer.reminder.reminderTitle': 'Customer Follow-up Reminder',
};
