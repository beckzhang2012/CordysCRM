export default {
  ...
  'customer.pleaseInputReminderContent': 'Please enter reminder content',
  'customer.reminderTimeCannotBeInPast': 'Reminder time cannot be in the past',
  'customer.reminderSetSuccess': 'Reminder set successfully',
  'customer.reminderSetFailed': 'Failed to set reminder',
  'customer.reminderList': 'Reminder List',
  'customer.noReminders': 'No reminders',
  'customer.upcomingReminders': 'Upcoming Reminders',
  'customer.noUpcomingReminders': 'No upcoming reminders',
  'customer.allReminders': 'All Reminders',
  'customer.markAsProcessed': 'Mark as Processed',
  'customer.processed': 'Processed',
  'customer.expired': 'Expired',
  'customer.reminderDeleteSuccess': 'Reminder deleted successfully',
  'customer.reminderDeleteFailed': 'Failed to delete reminder',
  'customer.reminderMarkedAsProcessed': 'Reminder marked as processed',
  'customer.reminderMarkFailed': 'Failed to mark reminder',
  'customer.reminderNotification': 'You have {count} customer follow-up reminders',
};
