export default {
  ...
  'customer.addReminder': 'Add Reminder',
  'customer.editReminder': 'Edit Reminder',
  'customer.deleteReminder': 'Delete Reminder',
  'customer.reminderStatus': 'Reminder Status',
  'customer.reminderStatus.PENDING': 'Pending',
  'customer.reminderStatus.TRIGGERED': 'Triggered',
  'customer.reminderStatus.DISMISSED': 'Dismissed',
  'customer.reminderNotification': 'Customer Reminder Notification',
  'customer.pleaseSelectReminderTime': 'Please select reminder time',
  'customer.pleaseEnterReminderContent': 'Please enter reminder content',
  'customer.reminderContentPlaceholder': 'Please enter reminder content (max 1000 characters)',
  'customer.reminderSetSuccess': 'Reminder set successfully',
  'customer.reminderDeleteSuccess': 'Reminder deleted successfully',
  'customer.reminderDismissSuccess': 'Reminder dismissed successfully',
  'customer.reminderUpdateSuccess': 'Reminder updated successfully',
  'customer.confirmDeleteReminder': 'Are you sure to delete this reminder?',
  'customer.noReminders': 'No reminders',
  'customer.viewAllReminders': 'View All Reminders',
};
