export default {
  ...
  'customer.reminder.remindTime': 'Reminder Time',
  'customer.reminder.selectTime': 'Select reminder time',
  'customer.reminder.content': 'Reminder Content',
  'customer.reminder.contentPlaceholder': 'Please enter reminder content',
  ...
  'customer.reminder.contentMaxLength': 'Reminder content cannot exceed 500 characters',
  'customer.reminder.setSuccess': 'Reminder set successfully',
  'customer.reminder.reminderList': 'Reminder List',
  'customer.reminder.allReminders': 'All Reminders',
  'customer.reminder.noReminder': 'No reminders',
  'customer.reminder.markAllRead': 'Mark all as read',
  'customer.reminder.markReadSuccess': 'Marked as read successfully',
  'customer.reminder.markAllReadSuccess': 'All marked as read successfully',
  'customer.reminder.deleteConfirm': 'Are you sure to delete this reminder?',
  'customer.reminder.viewAll': 'View All',
  'customer.reminder.pending': 'Pending',
  'customer.reminder.read': 'Read',
  'customer.reminder.today': 'Today',
};
