<template>
  ...
  >
    ...
    <div class="crm-form-create-footer" :class="formConfig.optBtnPos">
      ...
      <template v-else>
        <n-button v-if="formConfig.optBtnContent[0].enable" type="primary" :disabled="isSubmitting" @click="handleSave(false)">
          {{ formConfig.optBtnContent[0].text }}
        </n-button>
        <n-button v-if="formConfig.optBtnContent[1].enable" type="primary" ghost :disabled="isSubmitting" @click="handleSave(true)">
