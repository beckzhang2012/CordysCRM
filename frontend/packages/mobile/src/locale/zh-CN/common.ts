export default {
  ...
  'reminder.reminderTime': '提醒时间',
  'reminder.reminderContent': '提醒内容',
  'reminder.selectTime': '选择时间',
  'reminder.inputContent': '请输入提醒内容',
  'reminder.contentRequired': '提醒内容不能为空',
  'reminder.reminderList': '提醒列表',
  'reminder.markAllRead': '全部标为已读',
  'reminder.noReminder': '暂无提醒',
  'reminder.ago': '前',
  'reminder.hoursAgo': '小时前',
};
