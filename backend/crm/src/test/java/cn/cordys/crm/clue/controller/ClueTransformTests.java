...
import cn.cordys.common.i18n.Translator;
...
class ClueTransformTests extends BaseTest {
    ...
    private final List<Clue> createdClues = new ArrayList<>();
    ...
    void testConvertedClueTransform_ShouldBeRejected() throws Exception {
        ...
        String expectedMessage = Translator.get("clue.already.converted");
        ...
        Assertions.assertTrue(responseContent.contains(expectedMessage),
                "Response should contain message: " + expectedMessage + ", actual content: " + responseContent);
    ...
    void testSuccessStatusClueTransform_ShouldBeRejected() throws Exception {
        ...
        String expectedMessage = Translator.get("clue.already.closed");
    ...
    void testOppCreatedTrueButOppNameEmpty_ShouldBeRejected() throws Exception {
        ...
        String expectedMessage = Translator.get("clue.opportunity.name.not.blank");
